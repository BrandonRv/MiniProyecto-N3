        ...
        <div class="#">
            ...
            <div class=" px-8 h-20 w-full flex justify-start  items-center text-sm">
                ...
                <i class="fa-solid fa-camera-retro fa-lg"></i>
                    <input class=" w-1" type="file" id="archivo" accept="image/*" class="fancy-file" name="newFoto"
                        required>
                    <label class="flex justify-center items-centercursor-pointer absolute"
                        for="archivo">
            ...
            <div class="border-gray items-center justify-between text-gray-400 text-sm">
